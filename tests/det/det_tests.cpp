...
TEST(det, rounding_convention_kats) {
...
TEST(det, fix_abs_from_int_boundaries) {
...
TEST(det, fix_cos_large_angle_band) {
...
TEST(det, fix_overflow_contract) {
...
TEST(det, pcg32_range_fix01_edges) {
...
TEST(det, pcg32_stream_independence) {
