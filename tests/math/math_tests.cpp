...
// accidental GL/upside-down projection immediately. Self-registering (test.h, M1.4).
#include "test.h"
#include "math/math.h"
...
TEST(math, vec3_cross_normalize) {
...
TEST(math, mat4_mul_associativity) {
...
TEST(math, perspective_vk_clip_conventions) {
...
TEST(math, ortho_vk_clip_conventions) {
